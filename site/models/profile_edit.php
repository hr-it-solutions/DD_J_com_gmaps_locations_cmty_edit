 ...
 */
class DD_GMaps_Locations_CMTY_EditModelProfile_Edit extends JModelAdmin
{
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_dd_gmaps_locations_cmty_edit.edit.profile_edit.data', array());
		...
		if (empty($data))
		{
			...
			{
				$filters = (array) $app->getUserState('com_dd_gmaps_locations_cmty_edit.locations.filter');
				$data->set(
					'state',
					$app->input->getInt(
						'state',
		...
		$this->preprocessData('com_dd_gmaps_locations_cmty_edit.profile_edit', $data);
